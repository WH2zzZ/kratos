package com.oowanghan.kratos.web;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.oowanghan.kratos.web.model.KratosResponse;
...
public class WebUserController {
    ...
    public KratosResponse<String> register() {
        ...
        return KratosResponse.success("success");
    }

    @PostMapping("/login")
    public KratosResponse<String> login() {
        return KratosResponse.success("login success");
    }
